...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        // A closing menu stays mounted for its exit animation. Without this it
        // keeps taking clicks on the way out, which a modal menu got away with
        // only because the body was inert underneath it anyway.
